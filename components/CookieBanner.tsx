        ...
        >
          <div className="bg-[#1a0505] border-b border-[#731515]/30 sm:border sm:rounded-2xl px-6 sm:px-7 py-5 sm:py-6 flex flex-col gap-5 shadow-[0_8px_40px_rgba(0,0,0,0.5)]">
            ...
            <div className="flex items-center gap-4">
              <button
                onClick={accept}
                className="flex-1 py-3 bg-[#731515] hover:bg-[#9b2323] text-[#F5EEE6] text-[11px] tracking-[0.28em] transition-colors duration-200 rounded-lg"
                style={{ fontFamily: 'var(--font-nunito)' }}
              >
                ACCEPT
              </button>
              <button
                onClick={decline}
                className="flex-1 py-3 border border-white/15 hover:border-white/30 text-[#C4B5A0]/60 hover:text-[#C4B5A0] text-[11px] tracking-[0.28em] transition-all duration-200 rounded-lg"
                style={{ fontFamily: 'var(--font-nunito)' }}
              >
                DECLINE
              </button>
