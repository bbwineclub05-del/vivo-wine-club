...
import { requireAdminOrStaff, requireAdminStaffOrAssignedCollaborator } from '@/lib/auth-guard';
...
export async function GET(
  ...
  const auth = await requireAdminStaffOrAssignedCollaborator(request, slug);
